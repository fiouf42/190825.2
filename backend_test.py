...
class TikTokAPITester:
    ...
    def run_comprehensive_test(self):
        ...
        print("🔑 NEW OpenAI API Key: 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")
        print("🔑 NEW ElevenLabs API Key: sk_0ac8438144cbed68081b6b1bca798a1a81738fb00b5dac8d")
